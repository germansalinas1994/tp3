export default {
  background: {
    ...
    //para el primary button quiero un color azul
    primaryButton: "#4F5FD1", // Azul para botones principales, resalta la acción principal
  ...
  secondary: {
    main: "#4F5FD1", // Naranja vibrante para elementos secundarios
